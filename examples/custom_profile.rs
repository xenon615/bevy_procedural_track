...
fn startup(
    ...
    cmd.spawn((
        ...
        Camera::default(),
        FreeCamera::default(),
        Transform::from_xyz(2., 10., -4.).looking_at(Vec3::ZERO , Vec3::Y),
        AmbientLight {
            brightness: 100.,
            ..default()
        }
...
fn create_track(
    ...
    let points = (0 .. 10).map( | i | (vec3(0., 0., i as f32),Vec3::X)).collect::<Vec<_>>();
    ...
    let mesh = track_mesh(&points, EpTriangularDitch{half_width: 2., height: 1.5}, false);
